...
#
#	This file is part of UCUq.
#
#	UCUq is free software: you can redistribute it and/or
...
mods += plgn plgncore sck strmrg 
mods += scla scli sclm scle scll 
mods += sclr sclt 
mods += btr idxbtr idxque idxbtq 
mods += csdbns csdcmn csdscb 
mods += ucuinf ucucmn ucumng 
mods += common device manager messages modules 
mods += registry remote seeker switcher 
...
copt += -DVERSION=\""20241223"\"
copt += -DCOPYRIGHT_YEARS=\""2024"\"
copt += -DIDENTIFIER=\""cef8aca3-63e8-4de3-8499-5eb8a0ff7de6"\"
